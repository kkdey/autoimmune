...
```{r}
ra2_pbmc_bmmc <- get(load("../output/ra2_pbmc_bmmc_seurat.rda"))
```

```{r}
topic_clus_list <- get(load("../output/RA2_pbmc_bmmc_countclust.rda"))
```
...
```{r}
new_labs_2 <- new_labs[match(ra2_pbmc_bmmc@cell.names, colnames(aggr_data))]
